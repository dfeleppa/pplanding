...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // These were generated by WordPress event/booking plugins on the old
      // site. They have minimal traffic and no longer have analogues here,
      // so we redirect to the closest meaningful page.
      ...
      // ----- Force www to apex (Vercel/host can also enforce) -----
      // See seo/post-launch-checklist.md for the host-level configuration that
      // backstops this redirect.

      // ----- HTTP → HTTPS handled at host layer; document but don't try to do it here -----
    ];
  },
};
